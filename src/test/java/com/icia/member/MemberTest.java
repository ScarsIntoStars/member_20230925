...
// Assertions에 속한 모든 static 매서드를 사용할 때 매서드 이름만 작성해서 사용 가능하도록
...
public class MemberTest {
    // 테스트클래에서에서 사용할 클래스 객체 Autowired로 주입
    @Autowired
...
//        });
    ...
    */
    ...
    public void memberSaveTest() {
        // 1.
        MemberDTO newMember = new MemberDTO(); // 새로운 회원이 생긴다는 것은, 새로운 DTO가 생기는 것
        newMember.setMemberEmail("test_email17");
        ...
        // Assertions는 테스트 결과를 판단하는 기능을 가지고 있음

    }

    /**
     * 1.신규회원 가입
     * 2. 로그인을 위한 DTO객체 생성 후 로그인 수행
